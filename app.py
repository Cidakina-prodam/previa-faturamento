...
with st.sidebar:
    ...
    if tem_diretoria:
        ...
        diretorias_selecionadas = st.multiselect(
            "Diretoria", options=diretorias_existentes, default=diretorias_existentes,
    ...
    if tem_gerencia:
        ...
        gerencias_selecionadas = st.multiselect(
            "Gerência", options=gerencias_existentes, default=gerencias_existentes,
            label_visibility="collapsed",
        )
    ...
    if clientes_existentes_no_csv:
        clientes_selecionados = st.multiselect(
            "Clientes", options=clientes_existentes_no_csv, default=clientes_existentes_no_csv,
            label_visibility="collapsed",
        )
    else:
